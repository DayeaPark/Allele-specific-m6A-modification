...
m6Anet_alt_masked_rep1 = read.csv("./m6Anet_output/masked_mESC_rep1_alt.csv.gz", header = TRUE, sep = ",")
m6Anet_ref_masked_rep1 = read.csv("./m6Anet_output/masked_mESC_rep1_ref.csv.gz", header = TRUE, sep = ",")
m6Anet_alt_masked_rep2 = read.csv("./m6Anet_output/masked_mESC_rep2_alt.csv.gz", header = TRUE, sep = ",")
m6Anet_ref_masked_rep2 = read.csv("./m6Anet_output/masked_mESC_rep2_ref.csv.gz", header = TRUE, sep = ",")
...
prob85_merge_masked_rep1 = make_merge_file_with_prob_filter(m6Anet_all_rep1, m6Anet_alt_masked_rep1, m6Anet_ref_masked_rep1, m6Anet_und_rep1)

prob85_merge_rep2 = make_merge_file_with_prob_filter(m6Anet_all_rep2, m6Anet_alt_rep2, m6Anet_ref_rep2, m6Anet_und_rep2)
prob85_merge_masked_rep2 = make_merge_file_with_prob_filter(m6Anet_all_rep2, m6Anet_alt_masked_rep2, m6Anet_ref_masked_rep2, m6Anet_und_rep2)
```
